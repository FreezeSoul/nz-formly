...
import { BaseDatePickerOptions, DatePickerDateOptions } from '@freezesoul/nz-formly/date-picker';
...
export interface DatePickerRangeOptions extends Pick<DatePickerDateOptions, 'nzDisabledTime' | 'nzShowTime' | 'nzOnOk'> {
    /**
     * 预设时间范围快捷选择
     */
